...
export class FIFSAddrRegistrarData extends Contract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  );
  clone(): FIFSAddrRegistrarData;
  methods: {
    ...
    minCommitmentAge(): TransactionObject<string>;

    minLength(): TransactionObject<string>;
