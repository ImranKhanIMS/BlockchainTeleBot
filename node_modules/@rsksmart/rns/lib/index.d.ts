...
import { RNS, Contracts, Options, ChainId, Utils, Subdomains as ISubdomains } from './types';
...
export default class extends Composer implements RNS {
     ...
     */
    setAddr(domain: string, addr: string, chainId?: ChainId, options?: TransactionOptions): Promise<string>;
    /**
